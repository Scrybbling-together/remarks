...
document_with_various_highlights = {
...
@with_remarks(document_with_various_highlights['.rmn_source'])
@pytest.mark.markdown
def test_highlights_are_available_in_markdown():
    ...
    with open(f"tests/out/{document_with_various_highlights['notebook_name']} _obsidian.md") as f:
        content = f.read()
